...
def initGoods():
    ...
    c.execute(
        "INSERT INTO goods (name, description, price, image_path) VALUES ('Chicken Nugget Burger', 'Delicious chicken nuggets', 35.14, '../static/goods/Burger.jpg')")
    c.execute(
        "INSERT INTO goods (name, description, price, image_path) VALUES ('Coca-Cola', 'Wonderfull Softdrink', 5.14, '../static/goods/Coke.jpg')")
    conn.commit()
    c.execute(
        "INSERT INTO goods (name, description, price, image_path) VALUES ('chicken nuggets', 'Crunchy Nuggets', 25.14, '../static/goods/Nuggets.jpg')")
    conn.commit()
